from ai import combo, boostedsnail, snailbfs
...
if __name__ == "__main__":
	...
	methods = [[snail.preSnail, snail.snail], [boostedsnail.setDirection, boostedsnail.Bsnail], [snailbfs.pre, snailbfs.Gsnail]]
	for i in methods:
